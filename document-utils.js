...
function populateBillingCompanyInfo(elementPrefix = '') {
    ...
    // Set billing company details
    document.getElementById(`${prefix}billingCompanyName`).textContent = BILLING_COMPANY.name;
    document.getElementById(`${prefix}billingCompanyTagline`).textContent = BILLING_COMPANY.tagline;
    document.getElementById(`${prefix}billingCompanyAddress`).textContent = BILLING_COMPANY.address;
    document.getElementById(`${prefix}billingCompanyPhone`).textContent = BILLING_COMPANY.phone;
    document.getElementById(`${prefix}billingCompanyEmail`).textContent = BILLING_COMPANY.email;
